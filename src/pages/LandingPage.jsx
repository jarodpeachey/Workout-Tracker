    ...
    <div className="min-h-screen" style={{ backgroundColor: "#0a0a0a" }}>
      ...
      <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative pb-32 md:pb-40">
        <div className="max-w-6xl mx-auto px-6 py-20 md:py-32">
          <div className="text-center">
            <h1 className="text-[65px] md:text-[90px] font-bold mb-6 text-primary uppercase font-display tracking-wide drop-shadow-[0_0_30px_rgba(188,57,8,0.5)]">
              Project 1,000
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button
                ...
                className="px-8 py-3 bg-transparent hover:bg-primary/10 text-primary font-bold border-2 border-primary rounded-lg transition-all"
        ...
        <div className="absolute bottom-0 left-0 right-0 transform translate-y-[calc(50%+120px)] md:translate-y-1/2 px-6">
          <div className="max-w-4xl mx-auto">
            <div
              className="bg-gradient-to-br from-black to-gray-900 border border-primary/20 rounded-lg p-8 text-center"
            ...
            >
              ...
              <p className="text-[17px] md:text-[19px] text-white/70 leading-loose">
                A prestigious strength milestone achieved by totaling 1,000+
                pounds across your one-rep maxes in the bench press, squat, and
                deadlift. Project 1,000 helps you track, plan, and conquer this
                legendary feat.
              </p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 py-20 my-10 md:py-32 pt-[calc(256px+120px)] md:pt-48">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[19px] text-white/70 leading-loose">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-0 items-center mb-12 md:mb-16">
            <div className="md:pr-24 md:-mr-24">
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Add exercises, input your one-rep max, and choose your program
                style. Project 1,000 automatically calculates your working
                weights for every set.
              </p>
            </div>
            <div>
              <div
                className="bg-black rounded-3xl p-3 border-[1px] border-gray-dark w-full max-w-xs mx-auto"
                style={{
                  boxShadow:
                    "0 10px 40px rgba(188, 57, 8, 0.2), 0 0 20px rgba(255, 255, 255, 0.05)",
                }}
              >
                <img
                  src={step1}
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-0 items-center mb-12 md:mb-16 md:-mt-8">
            ...
            <div className="order-1 md:order-2 md:pl-24 md:-ml-24">
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Combine exercises into custom workout templates. Design
                different routines for different training days and save them to
                reuse week after week.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-0 items-center md:-mt-8">
            <div className="md:pr-24 md:-mr-24">
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Schedule templates across your training week. When it's time to
                train, complete each set and track every rep. Watch your
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[19px] text-white/70 mb-6 leading-loose">
              Monitor your 3-lift total in real-time as you approach the 1,000
              Pound Club. Track starting vs. current maxes and workout
              completion rates to stay accountable and motivated.
            </p>
          </div>
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-[19px] text-white/70 leading-loose">
            Everything you need to reach your strength goals
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-black to-gray-900 border border-primary/20 rounded-lg p-8 flex gap-4">
            ...
            <div>
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Auto-calculated working sets based on your maxes. Progressive
                overload made automatic. No thinking required—just lift.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-black to-gray-900 border border-primary/20 rounded-lg p-8 flex gap-4">
            ...
            <div>
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Plan your attack week by week. Structure your assault on the
                1,000 Pound Club with military precision.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-black to-gray-900 border border-primary/20 rounded-lg p-8 flex gap-4">
            ...
            <div>
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Track every lift with detailed analytics. Visualize your
                strength gains over time and see exactly how close you are to
                your goals.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-black to-gray-900 border border-primary/20 rounded-lg p-8 flex gap-4">
            ...
            <div>
              ...
              <p className="text-[17px] text-white/70 leading-loose">
                Your data securely stored and synced across all devices. Access
      ...
      {/* CTA & Footer */}
      <div
        className="pb-10 pt-16 md:pt-24 border-primary/40"
        style={{ backgroundColor: "#0a0a0a" }}
      >
        ...
        <div className="max-w-6xl mx-auto px-6 text-center mt-16">
          <p className="text-[16px] text-white/70 leading-loose">
            ©2025 Project 1,000
          </p>
        </div>
      </div>
